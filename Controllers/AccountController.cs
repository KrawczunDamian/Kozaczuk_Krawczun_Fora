...
namespace Fora2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, AvatarURL = @"\UploadedFiles\basic.user.png" };
                ...
                if (result.Succeeded)
                {
                    ...
                    newUser.Points = 0;
                    newUser.Rank = db.Ranks.FirstOrDefault(m => m.RankName == "Base");
                    newUser.MessagesPerPage = 5;
